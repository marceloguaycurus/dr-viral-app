...
import { getIntegrationConfig } from "@/lib/utils/dataFunctions/bd-management";
...
export default function IntegrationPage() {
  ...
  return (
    <div className="flex-1 mt-4 md:mt-0">
      <div className="space-y-6">
        <Integration data={integrationConfig || {}} error={integrationError} onSave={handleIntegrationSave} />
      </div>
    </div>
  );
}
