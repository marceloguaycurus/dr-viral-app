...
import { getHumanTransferConfig } from "@/lib/utils/dataFunctions/bd-management";
...
export default function TransferPage() {
  ...
  return (
    <div className="flex-1 mt-4 md:mt-0">
      <div className="space-y-6">
        <HumanTransfer data={humanTransferConfig || {}} error={humanTransferError} onSave={handleHumanTransferSave} />
      </div>
    </div>
  );
}
