...
import { PREFERENCES_TABS, PREFERENCES_TABS_CLASSES } from "@/lib/constants"
...
export default function PreferenciasLayout({
  ...
  return (
    <div className="flex-1 p-10 overflow-y-auto">
      ...
      <Tabs value={currentTab} orientation="vertical" className="flex flex-col md:flex-row md:space-x-6">
