...
import type { SelectedClinic } from "@/lib/utils/selected-clinic-cookie";
...
export async function changeClinicServerAction(
  clinic: { id: string; nome_clinica?: string; nome?: string; role?: string } | null
) {
  if (!clinic) {
